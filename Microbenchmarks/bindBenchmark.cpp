...
benchmarkResult bindingBenchmark_64(size_t nvec, size_t words) {
...
benchmarkResult bindingBenchmark_32(size_t nvec, size_t words) {
    ...
    hdc_word_t_32* q = (hdc_word_t_32*)aligned_alloc(ALIGNMENT, ((words * sizeof(hdc_word_t_32) + ALIGNMENT - 1) / ALIGNMENT) * ALIGNMENT);
    hdc_word_t_32* Z = (hdc_word_t_32*)aligned_alloc(ALIGNMENT, matrix_alloc_size);
    ...
    double bytes_read = (double)(matrix_words * sizeof(hdc_word_t_32)) + (double)(nvec * words * sizeof(hdc_word_t_32));
    double bytes_written = (double)(matrix_words * sizeof(hdc_word_t_32));
    double total_gigabytes = (bytes_read + bytes_written) / (1024.0 * 1024.0 * 1024.0);
...
benchmarkResult bindingBenchmark_16(size_t nvec, size_t words) {
    ...
    hdc_word_t_16* q = (hdc_word_t_16*)aligned_alloc(ALIGNMENT, ((words * sizeof(hdc_word_t_16) + ALIGNMENT - 1) / ALIGNMENT) * ALIGNMENT);
    hdc_word_t_16* Z = (hdc_word_t_16*)aligned_alloc(ALIGNMENT, matrix_alloc_size);
    ...
    double bytes_read = (double)(matrix_words * sizeof(hdc_word_t_16)) + (double)(nvec * words * sizeof(hdc_word_t_16));
    double bytes_written = (double)(matrix_words * sizeof(hdc_word_t_16));
    double total_gigabytes = (bytes_read + bytes_written) / (1024.0 * 1024.0 * 1024.0);
...
benchmarkResult bindingBenchmark_8(size_t nvec, size_t words) {
    benchmarkResult results;
    ...
    hdc_word_t_8* q = (hdc_word_t_8*)aligned_alloc(ALIGNMENT, ((words * sizeof(hdc_word_t_8) + ALIGNMENT - 1) / ALIGNMENT) * ALIGNMENT);
    hdc_word_t_8* Z = (hdc_word_t_8*)aligned_alloc(ALIGNMENT, matrix_alloc_size);
    ...
    double bytes_read = (double)(matrix_words * sizeof(hdc_word_t_8)) + (double)(nvec * words * sizeof(hdc_word_t_8));
    double bytes_written = (double)(matrix_words * sizeof(hdc_word_t_8));
    double total_gigabytes = (bytes_read + bytes_written) / (1024.0 * 1024.0 * 1024.0);
