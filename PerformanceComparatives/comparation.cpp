...
void bindComparation(size_t nvec, size_t words){
    ...
    double speedup_8 = (bind_64.gbs > 0) ? (bind_64.gbs / bind_8.gbs) : 0.0;
...
void hammerComparation(size_t nvec, size_t words){
    ...
    double speedup_8 = (hammer_64.gbs > 0) ? (hammer_64.gbs / hammer_8.gbs) : 0.0;
...
void queryComparation(size_t nvec, size_t words){
    ...
    double speedup_8 = (query_64.gbs > 0) ? (query_64.gbs / query_8.gbs) : 0.0;
